...
const ecommerceAlreadyAccountForm =
    document.getElementById("alreadyAccountForm");
...
const setUserNotExistError = form => {
    const errorSpan = document.querySelector(
        "#email + .alreadyAccountForm__custom-error"
    );
    if (errorSpan) {
        ...
        errorSpan.textContent =
            "Ouch, parece que no te has registrado con ese correo… Asegúrate de que esté bien redactado o ";
