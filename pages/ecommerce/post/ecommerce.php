...
<head>
    <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/ecommerce/post/ecommerce/seo-unreg.php'); ?>
...
<body class="emms__ecommerce">
    ...
    <main>
        <div class="register-form__container eventHiddenElements">
            <?php include($_SERVER['DOCUMENT_ROOT'] . '/components/ecommerce/post/register-form.php') ?>
        </div>
