            ...
            <ul class="emms__eventCards__list emms__eventCards__list--dk emms__fade-in">
                <li class="emms__eventCards__list__item">
                    ...
                    <div class="emms__eventCards__list__item__text">
                        ...
                        <p>Speakers internacionales líderes en Marketing Digital compartieron tendencias, estrategias y herramientas, que aplican las empresas más destacadas en la industria. ¡Descúbrelas! Revive gratis todas las conferencias de <a href="/ecommerce" class="emms__purple-common-anchor">la edición anterior.</a></p>
