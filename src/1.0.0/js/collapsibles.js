document.addEventListener("DOMContentLoaded", () => {
    ...
    const collapsiblesQuestionsListeners = () => {
        const accItem = document.querySelectorAll(
            ".emms__frequentquestions__list__item"
        );
        const accHD = document.querySelectorAll(
            ".emms__frequentquestions__list__item__head"
        );
        const toggleQuestionItem = itemCta => {
            ...
            if (itemClass == "emms__frequentquestions__list__item close") {
                itemCta.parentNode.className =
                    "emms__frequentquestions__list__item open";
            }
        };
